  ...
  export default {
    ...
    data() {
      ...
      return {
        options: [
          {
            value: 'https://test.lynlzqy.com/single/view/',
            label: '火柴人',
            children: [{
              value: 'https://test.lynlzqy.com/single/view/',
              label: '测试服'
            }, {
              value: 'https://single.zhangwangkj.cn/single/view/',
              label: '正式服',
            }]
          },
          {
            value: 'https://test.lynlzqy.com/dzjs/view/',
            label: '植物大战僵尸',
            children: [{
              value: 'https://test.lynlzqy.com/dzjs/view/',
              label: '测试服'
            }, {
              value: 'http://uc-dzjs.lynlzqy.com/dzjs/view/',
              label: '正式服',
            }]
          },
          {
            value: 'https://test.lynlzqy.com/bsqb/view/',
            label: '爆射奇兵',
            children: [{
              value: 'https://test.lynlzqy.com/bsqb/view/',
              label: '测试服'
            }, {
              value: 'http://bsqb.lynlzqy.com/bsqb/view/',
              label: '正式服',
            }]
          }],
