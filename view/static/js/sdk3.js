...
function ThinkData(serverUrl, appid, appkey, debug) {
    ...
    // 缓存
    ThinkData.instance = this;
}

ThinkData.prototype.getReportApi = function (eventName, reportType) {
...
ThinkData.prototype.timeStamp2Date = function (timestamp) {
...
ThinkData.prototype.getTimeStamp = function () {
    var time = Date.parse(new Date()).toString();//获取到毫秒的时间戳，精确到毫秒
    time = time.substr(0, 10);//精确到秒
    return time;
}

ThinkData.prototype.ajax = function (url, data, successFn, errFn) {
...
ThinkData.prototype.isJSONString = function (str) {
...
ThinkData.prototype.getDefaultAttr = function () {
...
ThinkData.prototype.browser = function () {
    var e = {type: "", version: ""};
    try {
...
ThinkData.prototype.isSameDay = function (t1, t2) {
...
ThinkData.prototype.track = function (eventName, attributesMap) {
...
ThinkData.prototype.os = function () {
...
ThinkData.prototype.getDeviceModel = function () {
...
ThinkData.prototype.getNetworkType = function () {
...
ThinkData.prototype._save = function () {
    this.setKVForClient(this.name, JSON.stringify(this._state));
}

ThinkData.prototype.getDistinctId = function () {
    return this._state["distinct_id"];
}

ThinkData.prototype.identify = function (e) {
    this._set("distinct_id", e);
}

ThinkData.prototype.clear = function () {
...
ThinkData.prototype.setAccountId = function (e) {
    this._set("xwl_account_id", e);
}

ThinkData.prototype.getAccountId = function () {
    return this._state["xwl_account_id"];
}

ThinkData.prototype.setSuperProperties = function (e) {
    this._set("super_properties", e);
}

ThinkData.prototype.unsetSuperProperties = function (e) {
    let tmp = this.getSuperProperties();
    delete tmp[e];
    this.setSuperProperties(tmp);
}

ThinkData.prototype.clearSuperProperties = function () {
    this._set("super_properties", {});
}

ThinkData.prototype.getSuperProperties = function () {
    return this._state["super_properties"] || {};
}

ThinkData.prototype.getUserProperties = function (e) {
    return this._state["user_properties"] || {};
}

ThinkData.prototype.userSet = function (data) {
...
ThinkData.prototype.userSetOnce = function (data) {
    let userProperties = this.getUserProperties();
...
ThinkData.prototype.userAdd = function (data) {
    let userProperties = this.getUserProperties();
...
ThinkData.prototype.userUnset = function (key) {
    let userProperties = this.getUserProperties();
...
ThinkData.prototype.login = function (e) {
    this._set("xwl_account_id", e);
}

ThinkData.prototype.getUserProperties = function () {
    return this._state["user_properties"] || {};
}

ThinkData.prototype.getDeviceId = function () {
    return this._state["device_id"];
}


ThinkData.prototype._setDeviceId = function (e) {
    this._state.hasOwnProperty("device_id") ? console.warn("Current device_id is ", this.getDeviceId(), ", it couldn't been set to: ", e) : this._set("device_id", e);
}
...
ThinkData.prototype.setRegTime = function (e) {
